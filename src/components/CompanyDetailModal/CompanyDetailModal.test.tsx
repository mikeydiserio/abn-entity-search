...
const mockCompany: CompanyEntity = SAMPLE_COMPANIES[0] as CompanyEntity;
...
describe("CompanyDetailModal Component", () => {
  ...
  test("should display business names section when available", () => {
    const companyWithBusinessNames = {
      ...mockCompany,
      business_names: [{ id: "1", name: "Test Business", type: "Main" }],
    };
...
export { mockCompany as mockCompanyForModal };
